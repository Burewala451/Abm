...
def main_apv():
    ...
    try:
        ...
        print ("         FREE USE THIS TERMUX COMMAND  : "+ak+myid)
        print ("[*]--------------------------------------------------------------")
        kok=open('/data/data/com.termux/files/usr/bin/.SHAHID-cov', 'w')
        kok.close()
        print ("")
        print ("")
        print ("     IF YOU HAVE A PROBLEM TO LOGING THIS COMMAND IN YOUR TERMUX PLEASE SEND ME A MSG ON MY WAHTSAPP OR PHONE NUMBER  ")
        print ("[*]--------------------------------------------------------------")
        time.sleep(6)
    ...
    if key1 in r1:
        ...
        print ("[*]--------------------------------------------------------------")
        print ("")
        print ("          FREE USE THIS  TERMUX COMMAND : "+ak+key1)
        print ("[*]--------------------------------------------------------------")
        print (" IF YOU HAVE A PROBLEM TO LOGING THIS COMMAND IN YOUR TERMUX PLEASE SEND ME A MSG ON MY WAHTSAPP OR PHONE NUMBER ")
        print ("[*]--------------------------------------------------------------")
        time.sleep(3.5)
				...
				for yntkts in self.id:
					try:
						...
						if len(xz) == 1:
							...
							pwx = [first13, xz[0] + 'last123', xz[0] + 'Frist123', xz[0] + 'Last1234']
						elif len(xz) == 3:
							pwx = [name, xz[0]+xz[1]]
						elif len(xz) == 4:
							pwx = [name, xz[0]+xz[1]]
